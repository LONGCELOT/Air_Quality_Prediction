...
class EnhancedAQICard extends StatelessWidget {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('Error',
                  style:
                      AppTextStyles.headline3.copyWith(color: AppColors.error)),
  ...
  Widget _buildEnhancedCard(BuildContext context, CurrentAQIData currentAQI,
      PredictionData? predictions, AQIProvider provider) {
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [Colors.white, aqiColor.withOpacity(0.05)],
          ),
        ),
        child: Padding(
  ...
  Widget _buildHeader(Color aqiColor) {
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Icon(Icons.air, color: aqiColor, size: 32),
        ),
      ],
    );
  }

  Widget _buildCurrentAQISection(
      CurrentAQIData currentAQI, Color aqiColor, String aqiLevel) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(aqi.toInt().toString(),
              style: AppTextStyles.headline2.copyWith(color: color, fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          Text(level.split(' ')[0],
                  ...
                  Flexible(
                    child: Text(
                      ...
                      style: AppTextStyles.caption.copyWith(
                          fontWeight: FontWeight.w600, color: color, fontSize: 9),
  ...
  Widget _buildLocationInfo(CurrentAQIData currentAQI, Color aqiColor) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.location_on, size: 18, color: aqiColor),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              currentAQI.location ?? 'Brasília, Brazil',
          ...
          Container(
            ...
            decoration:
                BoxDecoration(color: aqiColor.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
            child: Text('Live',
                style:
                    AppTextStyles.caption.copyWith(color: aqiColor, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
